...
run_if_present "Pi packages" pi update --extensions
run_if_present "Claude marketplaces" claude plugin marketplace update
run_if_present "Codex marketplaces" codex plugin marketplace upgrade
